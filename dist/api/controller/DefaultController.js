...
// src/api/controller/DefaultController.ts
var DefaultController_exports = {};
__export(DefaultController_exports, {
  default: () => DefaultController_default
});
module.exports = __toCommonJS(DefaultController_exports);
...
// src/api/controller/DefaultController.ts
var InitController = class {
  constructor() {
    this.itemType = "itemType_name";
  ...
  async create(body) {
    ...
    ;
    try {
      const res = await CRUD_default.create(body, this.itemType);
  ...
  async read(id) {
    try {
      const res = await CRUD_default.read(id);
  ...
  async delete(id) {
    try {
      const res = await CRUD_default.delete(id);
      return Util.resOk(res.body, `${this.itemType} read with success`);
    } catch (err) {
      return Util.resError(err);
    }
...
var DefaultController_default = new InitController();
